...
#fitlter intron and UTR and silent mutations 
includeType=c("Missense_Mutation","Nonsense_Mutation","Splice_Site")
met=met[which(met$Variant_Classification %in% includeType),]
